...
const QuickReplyMessages = ({ user, onQuickReplySelect }) => {
    ...
    const MEDIA_BASE_URL = "http://127.0.0.1:8000/storage/";
    ...
    const handleSaveQuickReply = async (newReply) => {
        ...
        try {
            ...
            if (response.data.status === 1) {
                ...
                toast.error(
                    response.data.message || "Failed to save quick reply"
                );
            }
        } catch (error) {
            toast.error(
                error.response?.data?.error || "Error saving quick reply"
            );
        }
                ...
                {filteredQuickReplies.map((reply) => (
                    ...
                    >
                        ...
                        <div
                            ...
                            onClick={() =>
                                handleQuickReplySelectInternal(reply)
                            }
                        >
