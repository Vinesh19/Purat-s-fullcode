            ...
            <div className="flex gap-12 items-center justify-center h-5/6">
                <div className="hidden basis-[44%] text-white lg:block">
                    ...
                    <ul className="flex gap-5 font-medium xl:text-xl">
                        <li>
                            <img
                                src="src/assets/images/svg/google.svg"
                                width={80}
                                height={80}
                            />
                        </li>
                        <li>
                            <img
                                src="src/assets/images/svg/netflix.svg"
                                width={80}
                                height={80}
                            />
                        </li>
                        <li>
                            <img
                                src="src/assets/images/svg/apple-logo.svg"
                                width={20}
                                height={80}
                            />
                        </li>
                        <li>
                            <img
                                src="src/assets/images/svg/garmin_logo.svg"
                                width={80}
                                height={80}
                            />
                        </li>
                        <li className=" mt-[-24px]">
                            <img
                                src="src/assets/images/svg/openai-logo.svg"
                                width={80}
                                height={80}
                            />
                        </li>
