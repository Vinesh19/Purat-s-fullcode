...
return new class extends Migration
{
    ...
    {
        Schema::create('_mob_no3_trials', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('success_full_per', 45)->default('0')->comment('3=fake, 0=real, 1=scrub pending')->nullable();
    ...
    {
        Schema::dropIfExists('_mob_no3_trials');
    }
};
